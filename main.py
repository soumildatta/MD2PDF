...
if __name__ == "__main__":
    ...
    # parser.add_argument('--type', type=str, choices=['single', 'folder' 'combined'], required=True, help='Specify whether to process a single file or multiple files in a folder.')
